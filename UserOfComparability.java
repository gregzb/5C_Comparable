...
public class UserOfComparability {
    ...
    public static void main(String[] commandLine) {
        ...
        reportRelationship( "Point vs. itself", p0, p0, "0");
         ...
         Date a = new Date(2002, 3, 5);

        reportRelationship( "Date vs itself", a
                , a, "0");

        Date b = new Date(2003, 2, 5);

        reportRelationship( "Date vs later date", a
                , b, "-1");

        reportRelationship( "Date vs earlier date", b
                , a, "1");



//        reportRelationship( "Date vs earlier date", new IncomparableDog()
//                , new IncomparableDog(), "1");
    }
